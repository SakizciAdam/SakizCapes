        ...
        switch (SakizCapes.getSettings().getCurrentMode()) {
            case URL:
                location = Minecraft.getMinecraft().getTextureManager()
                        .getDynamicTextureLocation(Reference.MOD_ID, new DynamicTexture(ImageUtils.getImageFromURL(SakizCapes.getSettings().getCapeURL())));
                break;
            case LOCAL:
                location = Minecraft.getMinecraft().getTextureManager()
                        .getDynamicTextureLocation(Reference.MOD_ID, new DynamicTexture(ImageUtils.getImageFromFile(SakizCapes.getSettings().getCapePath())));
                break;
            case CLIPBOARD:
