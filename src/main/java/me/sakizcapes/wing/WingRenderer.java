...
public class WingRenderer extends ModelBase {
	...
	public void onRenderPlayer(RenderPlayerEvent.Post event)
	{
		...
		if (SakizCapes.getSettings().isWingEnabled() && player.equals(mc.thePlayer) && !player.isInvisible()) // Should render wings onto this player?
		{
	...
	private void renderWings(EntityPlayer player, float partialTicks)
	{
		...
		double rotate = Settings.interpolate(player.prevRenderYawOffset, player.renderYawOffset, partialTicks);
